		...
		extend: {
			colors: {
				...
				pgbet: {
					...
					diamond: 'hsl(var(--pgbet-diamond))',
					platinum: 'hsl(var(--pgbet-platinum))'
				},
				sidebar: {
			...
			animation: {
				...
				'realistic-spin': 'realistic-spin 2.5s cubic-bezier(0.25, 0.46, 0.45, 0.94)',
				'realistic-spin-turbo': 'realistic-spin 1.2s cubic-bezier(0.25, 0.46, 0.45, 0.94)',
				'jackpot-explosion': 'jackpot-explosion 3s ease-out infinite',
				'confetti-burst': 'confetti-burst 2s ease-out infinite',
				'mascot-celebration': 'mascot-celebration 1.5s ease-in-out infinite',
				'button-pulse-premium': 'button-pulse-premium 2s ease-in-out infinite',
				'symbol-glow-dance': 'symbol-glow-dance 1s ease-in-out infinite',
				'win-line-sweep': 'win-line-sweep 1s ease-out',
				'floating-coins-premium': 'floating-coins-premium 4s ease-in-out infinite',
			...
			backgroundImage: {
				...
				'pgbet-gradient-gold': 'var(--pgbet-gradient-gold)',
				'pgbet-gradient-red': 'var(--pgbet-gradient-red)',
				'pgbet-gradient-emerald': 'var(--pgbet-gradient-emerald)',
				'pgbet-gradient-purple': 'var(--pgbet-gradient-purple)',
				'pgbet-gradient-machine': 'var(--pgbet-gradient-machine)',
				'pgbet-gradient-diamond': 'var(--pgbet-gradient-diamond)',
				'pgbet-gradient-platinum': 'var(--pgbet-gradient-platinum)'
			},
			boxShadow: {
