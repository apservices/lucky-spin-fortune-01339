    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pgbet-dark via-pgbet-crimson/20 to-pgbet-dark relative overflow-hidden flex items-center justify-center p-4">
        ...
        <div className="absolute inset-0 pointer-events-none">
          {/* Floating coins and emojis - mais intenso */}
          {[...Array(40)].map((_, i) => (
            <div
              key={i}
              className="absolute text-3xl md:text-4xl opacity-30 animate-floating-coins-premium"
              style={{
          ...
          {/* Fireworks effect - mais intenso */}
          <div className="absolute inset-0 bg-gradient-to-t from-transparent via-pgbet-gold/10 to-transparent animate-pulse" />
        </div>

        <div className="relative z-10 max-w-md w-full bg-gradient-to-b from-card/95 via-card/90 to-card/95 backdrop-blur-xl border-4 border-pgbet-gold rounded-3xl p-6 md:p-8 shadow-2xl">
          <div className="text-center space-y-4 md:space-y-6">
            {/* Animated tiger mascot */}
            <div className="relative">
              <div className="text-7xl md:text-8xl animate-mascot-celebration filter drop-shadow-2xl">🐯</div>
              <div className="absolute -top-2 -right-2 text-3xl md:text-4xl animate-bounce">✨</div>
              <div className="absolute -bottom-2 -left-2 text-3xl md:text-4xl animate-bounce delay-200">💫</div>
            </div>
            
            <div className="space-y-2">
              <h1 className="text-3xl md:text-4xl font-black bg-pgbet-gradient-gold bg-clip-text text-transparent animate-pulse">
                FORTUNE TIGER
              </h1>
              <p className="text-lg md:text-xl font-bold text-pgbet-gold">
                🎰 JOGO DO TIGRINHO RECREATIVO
              </p>
            </div>
            
            {/* Compliance warning - prominent */}
            <div className="bg-gradient-to-r from-pgbet-red/30 via-pgbet-red/20 to-pgbet-red/30 border-3 border-pgbet-red rounded-xl p-3 md:p-4 shadow-lg">
              <p className="text-xl md:text-2xl font-black text-pgbet-red mb-2 md:mb-3 animate-pulse">
                ⚠️ AVISO +18 ANOS
              </p>
              <div className="space-y-1 md:space-y-2 text-xs md:text-sm text-white/90 font-semibold">
                <p>🎮 JOGO RECREATIVO COM MOEDAS VIRTUAIS</p>
                <p className="text-sm md:text-base text-pgbet-gold font-black">
                  ❌ NÃO HÁ DINHEIRO REAL ENVOLVIDO
                </p>
                <p className="text-xs text-white/70 mt-1 md:mt-2">
            ...
            <button
              ...
              className="w-full h-14 md:h-16 text-xl md:text-2xl bg-pgbet-gradient-gold hover:scale-105 active:scale-95 transition-all duration-200 font-black text-pgbet-dark rounded-2xl shadow-2xl border-4 border-pgbet-gold/50 animate-button-pulse-premium relative overflow-hidden group"
            >
              <span className="relative z-10 flex items-center justify-center gap-2">
                🐯 TENHO +18 - JOGAR AGORA 🎰
              </span>
